  ...
  return (
    <>
      <section className="pd-hero wrap">
        ...
        {p.coverSide ? (
          <div className="pd-hero-side reveal" style={{ gridTemplateColumns: `1fr ${p.coverSideW || 260}px` }}>
            <div>
              ...
              <div className="pd-facts" data-stagger style={{ marginTop: 'clamp(32px,4vw,48px)' }}>
                {p.facts.map(([k, v]) => (
                  <div className="pd-fact" key={k}><div className="fl">{k}</div><div className="fv">{v}</div></div>
                ))}
              </div>
            </div>
            <div className="pd-hero-side-cover" style={{ maxWidth: p.coverSideW || 260 }}>
          ...
          <>
            ...
            <div className="pd-cover reveal" style={{ background: p.coverBg }}>
              <img src={p.cover} alt={p.title} style={p.coverContain ? { maxWidth: 520, margin: '48px auto' } : { objectPosition: p.pdCoverPos || 'top' }} />
            </div>
          </>
        )}
      </section>
